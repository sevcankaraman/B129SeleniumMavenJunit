...
public class C02_WebElementScreenShot extends TestBase {
    ...
    public void webElementScreenShot() throws IOException {
        ...
        /*
        sadece bir webelementin resmini alamk istersek,FileUtils.copyFile() methoduyla locate
         ettiğimiz webelementi kullanarak getScreenShotAs() methoduyla kullanarak resmını alabılırız.
